define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'apply/goods/index',
                    add_url: 'apply/goods/add',
                    edit_url: 'apply/goods/edit',
                    del_url: 'apply/goods/del',
                    multi_url: 'apply/goods/multi',
                    table: 'apply_goods',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'goods_intro', title: __('Goods_intro')},
